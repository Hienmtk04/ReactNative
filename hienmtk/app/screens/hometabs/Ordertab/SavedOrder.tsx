...
const SavedItem = () => {
  const saved = [
    ...
    { id: 's4', name: 'Cinnamon bun', description: 'Lorem Ipsum is simply dummy text', image: '../../../../assets/images/product/Croissant (1).png' },
    { id: 's5', name: 'Croissant', description: 'Lorem Ipsum is simply dummy text', image: '../../../../assets/images/product/Croissant (3).png' },
